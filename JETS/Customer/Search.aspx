<%@ Page Title="Search - JETS" Language="C#" MasterPageFile="~/Customer/Customer.Master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="JETS.Customer.Search" %>
<%@ Register TagPrefix="Recent" TagName="RecentlyViewed" Src="/Customer/RecentlyViewed.ascx" %>

<asp:Content ID="contentSearchCust" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    <script>
    ...
    <div class="album py-5 bg-white" style="padding-top:0 !important; padding-bottom:0 !important;">
                <div class="container">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Image] WHERE imageName LIKE '%' + @searchTerm + '%' ORDER BY imageDateUploaded DESC">
                        <SelectParameters>
