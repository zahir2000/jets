<%@ Page Title="Profile - JETS" Language="C#" MasterPageFile="~/Customer/Customer.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="Profile.aspx.cs" Inherits="JETS.Customer.Profile" %>
            ...
            <div class="container col-md-8">
                <div class="container pb-4">
                    <div class="row hrLine">
                        <h5 style="color: #008ecc; margin-bottom: 4px !important">Personal Information</h5>
                        <div style="margin-left: auto; padding-right:10px;"><i class="fa fa-question" data-toggle="tooltip" style="color: #008ecc" title="All Fields are Required"></i></div>
                    </div>
                </div>     
                ...
                <div class="row">
                    <div class="col-md pb-3 pb-md-0">
                        <div class="jets-group">
                            ...
                            <asp:RequiredFieldValidator ID="rfvFName" CssClass="error-message" ErrorMessage="Please enter your first name" runat="server" ControlToValidate="txtFName" ForeColor="#CC0000" ValidationGroup="Info" Display="Dynamic"></asp:RequiredFieldValidator>
                    ...
                    <div class="col-md pb-3 pb-md-0">
                        <div class="jets-group">
                            ...
                            <asp:RequiredFieldValidator ID="rfvLName" ErrorMessage="Please enter your last name" CssClass="error-message" runat="server" ControlToValidate="txtLName" ForeColor="#CC0000" ValidationGroup="Info" Display="Dynamic"></asp:RequiredFieldValidator>
                ...
                <div class="row pt-0 pt-md-2">
                    <div class="col-md pb-3 pb-md-0">
                        <div class="jets-group">
                            ...
                            <asp:RequiredFieldValidator ID="rfvNum" runat="server" CssClass="error-message" ErrorMessage="Please enter your phone number" ControlToValidate="txtPNum" ForeColor="#CC0000" ValidationGroup="Info" Display="Dynamic"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="revNum" runat="server" CssClass="error-message" ValidationExpression="^(\+601|01)[0-46-9]*[0-9]{7,8}$" ControlToValidate="txtPNum" ForeColor="#CC0000" ErrorMessage="Please enter a valid phone number. <br/>Eg: +60109993610 or 0109993610" ValidationGroup="Info" Display="Dynamic"></asp:RegularExpressionValidator>
                    ...
                    <div class="col-md pb-3 pb-md-0">
                            <div class="jets-group">
                                ...
                                <asp:RequiredFieldValidator ID="rfvEmail" runat="server" CssClass="error-message" ErrorMessage="Please enter your email" ControlToValidate="txtMail" ForeColor="#CC0000" ValidationGroup="Info" Display="Dynamic"></asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="revEmail" runat="server" CssClass="error-message" ErrorMessage="Please enter a valid email. Eg: yourname@site.com" ValidationExpression="^((([!#$%&'*+\-/=?^_`{|}~\w])|([!#$%&'*+\-/=?^_`{|}~\w][!#$%&'*+\-/=?^_`{|}~\.\w]{0,}[!#$%&'*+\-/=?^_`{|}~\w]))[@]\w+([-.]\w+)*\.\w+([-.]\w+)*)$" ControlToValidate="txtMail" ForeColor="#CC0000" ValidationGroup="Info" Display="Dynamic"></asp:RegularExpressionValidator>
                ...
                <div class="row pt-2">
                    <div class="col-md">
                        <div class="jets-group">
                            <textarea runat="server" class="jets-control txtAdd" id="txtAdd" />
                            <label for="txtAddress">Address</label>
                            <asp:RequiredFieldValidator ID="rfvAdd" runat="server" CssClass="error-message error-message-textarea" ControlToValidate="txtAdd" ForeColor="#CC0000" ErrorMessage="Please enter your address" ValidationGroup="Info" Display="Dynamic"></asp:RequiredFieldValidator>
                ...
                <div class="container">
                    <div class="row justify-content-end" style="width: 250px; float: right;">
                        <asp:Button runat="server" ID="btnSave" text="Save Changes" CssClass="jets-btn" OnClick="btnSave_Click" ValidationGroup="Info"></asp:Button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center pt-5">
            <div class="container col-md-8">
                <div class="container pb-3">
                    <div class="row hrLine">
                        <h5 style="color: #008ecc; margin-bottom: 4px !important">Password</h5>
                        <div style="margin-left: auto; padding-right:10px;"><i class="fa fa-question" data-toggle="tooltip" style="color: #008ecc" title="Password must be between 6-16 characters & alphanumerical"></i></div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row justify-content-end pt-2" style="width: 250px; float: right;">
                        <asp:Button runat="server" ID="btnSavePass" text="Save Password" CssClass="jets-btn" OnClick="btnSavePass_Click" ValidationGroup="PasswordValidation"></asp:Button>
                    </div>
                </div>
            </div>
        </div>
