<%@ Page Title="Upload Artwork - JETS" Language="C#" MasterPageFile="~/Artist/Artist.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="Upload.aspx.cs" Inherits="JETS.Artist.Upload" %>

<asp:Content ID="contentNewArtWork" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-light">
            <li class="breadcrumb-item dark-blue-color"><a href="Gallery.aspx"><i class="fa fa-home"></i></a></li>
              <li class="breadcrumb-item dark-blue-color"><a href="Gallery.aspx">Uploads</a></li>
            <li class="breadcrumb-item active" aria-current="page">New Art Work</li>
          </ol>
        </nav>
    </div>

    <section class="jumbotron text-center bg-white" style="padding-top:30px; padding-bottom:20px">
                <div class="container">
                    <h1 class="jumbotron-heading"><i class="fa fa-plus"></i> New Artwork</h1>
                </div>
    </section>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body text-center">
                            ...
                            <span style="font-size: 1.3rem;">Upload Successful<br></span>
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-md-8 pr-md-5">
                ...
                <div class="jets-group" style="padding-bottom: 5px;">
                    ...
                    <asp:RequiredFieldValidator ID="rvfName" runat="server" CssClass="error-message" ControlToValidate="txtImageName" ErrorMessage="Please enter the image name" Display="Dynamic" ForeColor="#CC0000" ValidationGroup="New"></asp:RequiredFieldValidator>
                ...
                <div class="jets-group" style="padding-bottom: 5px;">
                    ...
                    <asp:RequiredFieldValidator ID="rvfDesc" runat="server" ControlToValidate="txtDescription" CssClass="error-message" ErrorMessage="Please enter the image description" Display="Dynamic" ForeColor="#CC0000" ValidationGroup="New"></asp:RequiredFieldValidator>
                ...
                <div class="row">
                    ...
                    <div class="jets-group">
                        ...
                        <asp:RequiredFieldValidator ID="rvfPrice" runat="server" CssClass="error-message value-validation" ControlToValidate="txtPrice" ErrorMessage="Please enter the price" Display="Dynamic" ForeColor="#CC0000" ValidationGroup="New"></asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="rngPrice" runat="server" CssClass="error-message value-validation" ControlToValidate="txtPrice" ErrorMessage="Price must be between 1 and 9999<br/>Value must be a integer or double" MaximumValue="9999" MinimumValue="1" Width="100%" ValidationGroup="New" Display="Dynamic" Type="Double"></asp:RangeValidator>
                ...
                <div class="col-md">
                    <div class="jets-group">
                        ...
                        <asp:RequiredFieldValidator ID="rvfQty" runat="server" CssClass="error-message value-validation" ControlToValidate="txtQty" ErrorMessage="Please enter the quantity" Display="Dynamic" ForeColor="#CC0000" ValidationGroup="New"></asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="rngQty" runat="server" CssClass="error-message value-validation" ControlToValidate="txtQty" ErrorMessage="Quantity must be between 1 and 999<br/>Value must be an integer" MaximumValue="999" MinimumValue="1" Width="100%" ValidationGroup="New" Display="Dynamic" Type="Integer"></asp:RangeValidator>
            ...
            <div class="col-md-4 pt-md-0 pt-5">
                <div class="card jets-box">
                    <img id="imgPreview" class="card-img-top" src="noimage.png" />
                    <div class="card-body">  
                        <div class="img">
                            <asp:FileUpload ID="fuImage" runat="server" onchange="ShowPreview(this);" />
                            <asp:RequiredFieldValidator ID="rvfImg" runat="server" ControlToValidate="fuImage" CssClass="field-validation-error" ErrorMessage="" ValidationGroup="New"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="card-footer">
                        <div class="row" style="padding-right: 10px;">
                            ...
                            <div class="col-sm-8 pr-sm-0 pb-2 pb-sm-0" style="padding-left: 5px;">
                                <asp:Button ID="btnUpload" runat="server" Text="Upload" OnClick="btnUpload_Click" CssClass="jets-btn jets-artist-btn submit-btn" ValidationGroup="New" />                  
                            </div>
                        </div>
                    </div>
                </div>
